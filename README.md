...
#### Heating System
The heater was purchased from amazon and consists of two parts: the electric heating element and fan. To simplify the wiring and to ensure that the fan and heating element would be on at the same time, the ground and power wires for each component were spliced together. The heater was mounted to the middle of the tub using nuts and bolts, which allows for the cooling system to have ample space. Other components associated with system was a TIP 31C transistor, 1kΩ resistor, and an automotive relay (12 VDC, 40A) and are housed in the electronics housing. This system is wired according to the provided schematic above.
#### Lights
